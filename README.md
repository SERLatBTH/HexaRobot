...
You can also find [example code](https://github.com/vincross/mind-sdk/tree/master/examples) on github [repository](https://github.com/vincross/mind-sdk/tree/master/examples) as well.


### MIND Studio
To create skills for MIND platform you can use MIND Studio an initiative toolkit which is available for download for Windows, MacOS and Linux. Just go to the [developer page](https://developer.vincross.com/en) and scroll until you see mind studio.
